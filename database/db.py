...
class User(Base):
    ...
    name = Column(String)
    role = Column(String, default="member")  # guest/member/vip/admin
    membership = Column(String, default="free")  # free/pro/vip
    vip_expire = Column(DateTime)
    token_balance = Column(Integer, default=0)
    daily_limit = Column(Integer, default=3)  # 每日分析次数限制
