...
```bash
cd stock_ai
python data_sync/get_stock_list.py       # 获取股票列表
python data_sync/sync_cn_daily.py        # 同步所有股票日线
```

### 每日增量更新
```bash
python data_sync/update_cn_daily.py      # 只更新最新交易日
```
...
### V8: Factor + Signal + Leader 系统（进行中）
...
*系统版本：V8.0 Factor + Signal + Leader*
*最后更新：2026-05-10*
